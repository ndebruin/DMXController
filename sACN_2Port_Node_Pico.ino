...
// mac address
byte mac[] = {0x00, 0xC0, 0x16, 0xB7, 0xA3, 0xD5};
...
uint16_t redBlinkInterval = 5000;

// static IP data
IPAddress IP(10, 101, 0, 60);
...
void redBlink(){
  ...
  if(currentRed - lastRed >= redBlinkInterval){
    lastRed = currentRed;
